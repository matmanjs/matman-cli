...
class ActionHandle {
    ...
    async getResult() {
        ...
        if (this.matmanQuery && (typeof this.matmanQuery === 'object') && (typeof this.matmanQuery.getQueryString === 'function')) {
     ...
     * @param matmanQuery
     */
    setMatmanQuery(matmanQuery) {
        this.matmanQuery = matmanQuery;
    }
