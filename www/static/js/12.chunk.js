...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _action = __webpack_require__(701);
	...
	var StubList = function (_Component) {
	  (0, _inherits3.default)(StubList, _Component);
	
	  function StubList(props, context) {
	    (0, _classCallCheck3.default)(this, StubList);
	  ...
	  StubList.prototype.componentDidMount = function componentDidMount() {
	    console.log('StubList componentDidMount', this.props);
	
	    this.props.loadStubList();
	  };
	
	  StubList.prototype.getAllTags = function getAllTags(list) {
	  ...
	  StubList.prototype.handleClickTag = function handleClickTag(tagName) {
	    this.setState({
	      curTag: tagName
	    });
	  };
	
	  StubList.prototype.render = function render() {
	    var _this2 = this;
