...
var _action = __webpack_require__(246);
...
var StubList = function (_Component) {
  _inherits(StubList, _Component);

  function StubList(props, context) {
    _classCallCheck(this, StubList);

    var _this = _possibleConstructorReturn(this, (StubList.__proto__ || Object.getPrototypeOf(StubList)).call(this, props, context));
...
function mapStateToProps(state) {
  var stubListInfo = state.stubListInfo;
...
function mapDispatchToProps(dispatch) {
  return {
    loadStubList: function loadStubList() {
      return dispatch((0, _action.loadStubList)());
    }
  };
}

exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(StubList);
...
exports = module.exports = __webpack_require__(18)();
exports.push([module.i, ".stubs-list .tag-wrapper {\n  margin: 10px 0;\n}\n.stubs-list .list-wrapper .ant-card {\n  margin-bottom: 16px;\n  font-size: 14px;\n}\n.stubs-list .list-wrapper .ant-card .detail {\n  margin-bottom: 20px;\n}\n", ""]);
