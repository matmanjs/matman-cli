...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _action = __webpack_require__(697);
	...
	var ReporterList = function (_Component) {
	  (0, _inherits3.default)(ReporterList, _Component);
	
	  function ReporterList(props, context) {
	    (0, _classCallCheck3.default)(this, ReporterList);
	  ...
	  ReporterList.prototype.componentDidMount = function componentDidMount() {
	    console.log('ReporterList componentDidMount', this.props);
	
	    this.props.loadReporterList();
	  };
	
	  ReporterList.prototype.getAllTags = function getAllTags(list) {
	  ...
	  ReporterList.prototype.handleClickTag = function handleClickTag(tagName) {
	    this.setState({
	      curTag: tagName
	    });
	  };
	
	  ReporterList.prototype.render = function render() {
	    var _this2 = this;
