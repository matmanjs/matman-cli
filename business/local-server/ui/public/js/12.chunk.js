...
var _action = __webpack_require__(369);
...
var ReporterList = function (_Component) {
  _inherits(ReporterList, _Component);

  function ReporterList(props, context) {
    _classCallCheck(this, ReporterList);

    var _this = _possibleConstructorReturn(this, (ReporterList.__proto__ || Object.getPrototypeOf(ReporterList)).call(this, props, context));
  ...
  _createClass(ReporterList, [{
    ...
    key: 'getAllTags',
    value: function getAllTags(list) {
    ...
    key: 'handleClickTag',
    value: function handleClickTag(tagName) {
      this.setState({
        curTag: tagName
      });
    }
            ...
            return item.tags.indexOf(curTag) > -1 ? _react2.default.createElement(
              ...
              _react2.default.createElement(
                ...
                _react2.default.createElement(
                  ...
                  _react2.default.createElement(
                    _reactRouter.Link,
                    { to: '/admin/reporters/reporter/' + item.name },
                    _react2.default.createElement(
                      _button2.default,
                      { type: 'primary', size: 'large', icon: 'tool' },
                      '\u66F4\u591A...'
                    )
                  )
                )
...
function mapStateToProps(state) {
  var reporterListInfo = state.reporterListInfo;
...
function mapDispatchToProps(dispatch) {
  return {
    loadReporterList: function loadReporterList() {
      return dispatch((0, _action.loadReporterList)());
    }
  };
}

exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(ReporterList);
...
exports = module.exports = __webpack_require__(47)();
exports.push([module.i, ".reporters-list .tag-wrapper {\n  margin: 10px 0;\n}\n.reporters-list .list-wrapper .ant-card {\n  margin-bottom: 16px;\n  font-size: 14px;\n}\n.reporters-list .list-wrapper .ant-card .detail {\n  margin-bottom: 20px;\n}\n", ""]);
